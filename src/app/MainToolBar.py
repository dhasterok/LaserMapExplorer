...
class MainActions(QObject):
    ...
    def connect_logger(self):
        ...
        ## MainWindow toolbar
        self.OpenSample.triggered.connect(lambda: log("actions.OpenSample", prefix="UI"))
        self.OpenDirectory.triggered.connect(lambda: log("actions.OpenDirectory", prefix="UI"))
        self.OpenProject.triggered.connect(lambda: log("actions.OpenProject", prefix="UI"))
        self.SaveProject.triggered.connect(lambda: log("actions.SaveProject", prefix="UI"))
        self.SelectAnalytes.triggered.connect(lambda: log("actions.SelectAnalytes", prefix="UI"))
        self.WorkflowTool.triggered.connect(lambda: log("actions.WorkflowTool", prefix="UI"))
        self.FullMap.triggered.connect(lambda: log("actions.FullMap", prefix="UI"))
        self.Crop.triggered.connect(lambda: log("actions.Crop", prefix="UI"))
        self.SwapAxes.triggered.connect(lambda: log("actions.SwapAxes", prefix="UI"))
        self.NoiseReduction.triggered.connect(lambda: log("actions.NoiseReduction", prefix="UI"))
        self.ClearFilters.triggered.connect(lambda: log("actions.ClearFilters", prefix="UI"))
        self.Filters.triggered.connect(lambda: log("actions.Filters", prefix="UI"))
        self.PolygonMask.triggered.connect(lambda: log("actions.PolygonMask", prefix="UI"))
        self.ClusterMask.triggered.connect(lambda: log("actions.ClusterMask", prefix="UI"))
        self.UpdatePlot.triggered.connect(lambda: log("actions.UpdatePlot", prefix="UI"))
        self.SavePlotToTree.triggered.connect(lambda: log("actions.SavePlotToTree", prefix="UI"))
        self.Notes.triggered.connect(lambda: log("actions.Notes", prefix="UI"))
        self.Calculator.triggered.connect(lambda: log("actions.Calculator", prefix="UI"))
        self.ReportBug.triggered.connect(lambda: log("actions.ReportBug", prefix="UI"))
        self.Help.triggered.connect(lambda: log("actions.Help", prefix="UI"))
        self.Reset.triggered.connect(lambda: log("actions.Reset", prefix="UI"))
...
class MainMenubar(QMenuBar):
    def __init__(self, ui, actions: MainActions):
        ...
        self.menuLaME.addAction(actions.Preferences)
        self.menuLaME.addAction(actions.About)
        self.menuLaME.addSeparator()
        self.menuLaME.addAction(actions.Preferences)
        self.menuLaME.addAction(actions.ViewMode)
        self.menuLaME.addSeparator()
        self.menuLaME.addAction(actions.Quit_LaME)
        ...
        self.menuFile.addAction(actions.OpenSample)
        self.menuFile.addAction(actions.OpenDirectory)
        self.menuFile.addAction(actions.OpenProject)
        self.menuFile.addAction(actions.SpotData)
        self.menuFile.addSeparator()
        self.menuFile.addAction(actions.SaveProject)
        self.menuFile.addAction(actions.SaveFigure)
        self.menuFile.addSeparator()
        self.menuFile.addAction(actions.Reset)
        self.menuFile.addAction(actions.ImportFiles)
        self.menuFile.addAction(actions.ImportSpots)
        ...
        self.menuPlot.addAction(actions.Correlation)
        self.menuPlot.addAction(actions.Histograms)
        self.menuPlot.addAction(actions.BiPlot)
        self.menuPlot.addAction(actions.Ternary)
        self.menuPlot.addAction(actions.TEC)
        self.menuPlot.addAction(actions.Radar)
        self.menuPlot.addAction(actions.Cluster)
        self.menuPlot.addSeparator()
        self.menuPlot.addAction(actions.SavePlotToTree)
        ...
        self.menuAnalyze.addAction(actions.FilterToggle)
        self.menuAnalyze.addAction(actions.PolygonMask)
        self.menuAnalyze.addAction(actions.ClusterMask)
        self.menuAnalyze.addAction(actions.NoiseReduction)
        self.menuAnalyze.addSeparator()
        self.menuAnalyze.addAction(actions.Compare_Spot_Map)
        self.menuAnalyze.addAction(actions.Profiles)
        ...
        self.menuTools.addAction(actions.Filters)
        self.menuTools.addAction(actions.Polygons)
        self.menuTools.addAction(actions.Clusters)
        self.menuTools.addSeparator()
        self.menuTools.addAction(actions.SpotTools)
        self.menuTools.addAction(actions.Profiles)
        self.menuTools.addAction(actions.SpecialTools)
        self.menuTools.addAction(actions.Regression)
        self.menuTools.addSeparator()
        self.menuTools.addAction(actions.Info)
        self.menuTools.addAction(actions.Logger)
        self.menuTools.addAction(actions.Calculator)
        self.menuTools.addAction(actions.Notes)
        self.menuTools.addSeparator()
        self.menuTools.addAction(actions.WorkflowTool)
        ...
        self.menuHelp.addAction(actions.UserGuide)
        self.menuHelp.addAction(actions.Tutorials)
        self.menuHelp.addSeparator()
        self.menuHelp.addAction(actions.ReportBug)
...
class MainToolbar(QToolBar):
    def __init__(self, ui, actions: MainActions):
        ...
        self.addAction(actions.OpenSample)
        self.addAction(actions.OpenDirectory)
        self.addAction(actions.ImportFiles)
        self.addAction(actions.ImportSpots)
        self.addAction(actions.OpenProject)
        self.addAction(actions.SaveProject)
        self.addSeparator()
        #self.addWidget(sample_widget)
        self.addAction(actions.SelectAnalytes)
        self.insertWidget(actions.SelectAnalytes, sample_widget)
        self.addAction(actions.WorkflowTool)
        self.addSeparator()
        self.addAction(actions.FullMap)
        self.addAction(actions.Crop)
        self.addAction(actions.SwapAxes)
        self.addSeparator()
        self.addAction(actions.NoiseReduction)
        self.addAction(actions.ClearFilters)
        self.addAction(actions.FilterToggle)
        self.addAction(actions.PolygonMask)
        self.addAction(actions.ClusterMask)
        self.addSeparator()
        self.addAction(actions.UpdatePlot)
        self.addAction(actions.SavePlotToTree)
        self.addSeparator()
        self.addAction(actions.Notes)
        self.addAction(actions.Calculator)
        self.addSeparator()
        self.addAction(actions.ReportBug)
        self.addAction(actions.Reset)
        self.addAction(actions.Help)
        self.addAction(actions.ViewMode)
