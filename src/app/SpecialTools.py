...
class SpecialPage(QWidget):
    def __init__(self, page_index, parent=None):
        ...
        self.scrollAreaSpecial.setFrameShape(QFrame.Shape.NoFrame)
        self.scrollAreaSpecial.setFrameShadow(QFrame.Shadow.Plain)
        ...
        self.formLayout_16.setWidget(0, QFormLayout.ItemRole.LabelRole, self.labelThermometryMethod)
        ...
        self.formLayout_16.setWidget(0, QFormLayout.ItemRole.FieldRole, self.ComboBoxThermometryMethod)
        ...
        self.scrollAreaBarometry.setFrameShape(QFrame.Shape.NoFrame)
        self.scrollAreaBarometry.setFrameShadow(QFrame.Shadow.Plain)
        ...
        self.formLayout_17.setWidget(0, QFormLayout.ItemRole.LabelRole, self.labelBarometryMethod)
        ...
        self.formLayout_17.setWidget(0, QFormLayout.ItemRole.FieldRole, self.ComboBoxBarometryMethod)
        ...
        spacerItem15 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        self.scrollAreaDiffusion.setFrameShape(QFrame.Shape.NoFrame)
        self.scrollAreaDiffusion.setFrameShadow(QFrame.Shadow.Plain)
