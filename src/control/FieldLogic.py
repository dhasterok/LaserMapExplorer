...
from src.control.Preprocessing import PreprocessingUI
from src.plotting.LamePlotUI import HistogramUI, CorrelationUI, ScatterUI, NDimUI
from src.control.ImageProcessing import ImageProcessingUI
...
from src.plotting.LamePlot import plot_clusters
    ...
    def update_field_type_combobox(self, comboBox, addNone=False, plot_type=''):
        ...
        match plot_type.lower():
            ...
            case _:
                ...
                if 'Diffusion model' in data_type_dict:
                    field_list.append('Diffusion model')
