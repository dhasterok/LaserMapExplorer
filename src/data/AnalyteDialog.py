...
from PyQt6.QtWidgets import (
    QMessageBox, QDialog, QTableWidget, QTableWidgetItem, QLabel, QComboBox, QAbstractItemView, QGridLayout,
    QHeaderView, QFileDialog, QCheckBox, QPushButton, QComboBox, QSizePolicy
)
...
class AnalyteDialog(QDialog):
    ...
    def setupUi(self, Dialog):
        ...
        self.pushButtonCancel = QPushButton(parent=Dialog)
        self.pushButtonCancel.setText("Cancel")
        font = QFont()
        font.setPointSize(11)
        self.pushButtonCancel.setFont(font)
        self.pushButtonCancel.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        ...
        self.pushButtonLoadSelection = QPushButton(parent=Dialog)
        self.pushButtonLoadSelection.setText("Load")
        font = QFont()
        font.setPointSize(11)
        self.pushButtonLoadSelection.setFont(font)
        self.pushButtonLoadSelection.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        ...
        self.tableWidgetAnalytes = QTableWidget(parent=Dialog)
        font = QFont()
        font.setPointSize(11)
        self.tableWidgetAnalytes.setFont(font)
        self.tableWidgetAnalytes.setSelectionMode(QAbstractItemView.SelectionMode.MultiSelection)
        ...
        self.pushButtonSaveSelection = QPushButton(parent=Dialog)
        self.pushButtonSaveSelection.setText("Save")
        font = QFont()
        font.setPointSize(11)
        self.pushButtonSaveSelection.setFont(font)
        self.pushButtonSaveSelection.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        ...
        self.pushButtonDone = QPushButton(parent=Dialog)
        self.pushButtonDone.setText("Done")
        font = QFont()
        font.setPointSize(11)
        self.pushButtonDone.setFont(font)
        self.pushButtonDone.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        self.pushButtonDone.setObjectName("pushButtonDone")
        self.gridLayout.addWidget(self.pushButtonDone, 5, 6, 1, 1)
        self.labelColorbar = QLabel(parent=Dialog)
        self.labelColorbar.setMaximumSize(QSize(40, 200))
        font = QFont()
        font.setPointSize(11)
        ...
        self.comboBoxCorrelation = QComboBox(parent=Dialog)
        font = QFont()
        font.setPointSize(11)
        ...
        self.comboBoxScale = QComboBox(parent=Dialog)
        font = QFont()
        font.setPointSize(11)
        ...
        self.tableWidgetSelected = QTableWidget(parent=Dialog)
        self.tableWidgetSelected.setMaximumSize(QSize(300, 16777215))
        font = QFont()
        font.setPointSize(11)
    ...
    def _set_col_font(self, col, weight, brush):
        ...
        ----------
        col : int
            Column index to set font weight.
        weight : QFont.Weight
            Font weight to apply.
        brush : QBrush
            Background brush to apply.
        """
        if col is not None:
