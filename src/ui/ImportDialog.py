...
class Ui_ImportDialog(object):
    def setupUi(self, ImportDialog):
        ...
        self.statusBar.setGeometry(QtCore.QRect(0, 620, 1024, 27))
        ...
        self.widget = QtWidgets.QWidget(ImportDialog)
        self.widget.setGeometry(QtCore.QRect(12, 12, 1001, 606))
        ...
        self.labelDataType = QtWidgets.QLabel(self.widget)
        ...
        self.toolButtonOpenDirectory = QtWidgets.QToolButton(self.widget)
        ...
        self.toolButtonOpenDirectory.setIconSize(QtCore.QSize(20, 20))
        ...
        self.labelAddStandard = QtWidgets.QLabel(self.widget)
        self.labelAddStandard.setObjectName("labelAddStandard")
        self.horizontalLayout_5.addWidget(self.labelAddStandard)
        self.toolButtonAddStandard = QtWidgets.QToolButton(self.widget)
        ...
        self.toolButtonAddStandard.setIconSize(QtCore.QSize(18, 18))
        ...
        self.checkBoxPreview = QtWidgets.QCheckBox(self.widget)
        ...
        self.tableWidgetMetadata = QtWidgets.QTableWidget(self.widget)
        ...
        self.checkBoxApplyAll = QtWidgets.QCheckBox(self.widget)
        ...
        self.checkBoxSaveToRoot = QtWidgets.QCheckBox(self.widget)
        ...
        self.framePreviewSample = QtWidgets.QFrame(self.widget)
        ...
        self.toolButtonPrevSample = QtWidgets.QToolButton(self.widget)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/resources/icons/icon-left-arrow-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonPrevSample.setIcon(icon3)
        self.toolButtonPrevSample.setIconSize(QtCore.QSize(20, 20))
        self.toolButtonPrevSample.setObjectName("toolButtonPrevSample")
        self.horizontalLayout_3.addWidget(self.toolButtonPrevSample)
        self.labelSampleID = QtWidgets.QLabel(self.widget)
        ...
        self.toolButtonNextSample = QtWidgets.QToolButton(self.widget)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/resources/icons/icon-right-arrow-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonNextSample.setIcon(icon4)
        self.toolButtonNextSample.setIconSize(QtCore.QSize(20, 20))
        self.toolButtonNextSample.setObjectName("toolButtonNextSample")
        self.horizontalLayout_3.addWidget(self.toolButtonNextSample)
        self.labelResolution = QtWidgets.QLabel(self.widget)
        ...
        self.pushButtonImport = QtWidgets.QPushButton(self.widget)
        font = QtGui.QFont()
        font.setPointSize(11)
    ...
    def retranslateUi(self, ImportDialog):
        ...
        self.comboBoxDataType.setItemText(4, _translate("ImportDialog", "Petrography photo"))
        ...
        item.setText(_translate("ImportDialog", "Filename\n"
"format"))
...
"reverse"))
        ...
        item.setText(_translate("ImportDialog", "Delimiter"))
