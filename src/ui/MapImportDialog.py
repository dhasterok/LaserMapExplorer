...
class Ui_MapImportDialog(object):
    def setupUi(self, MapImportDialog):
        ...
        self.labelDataType = QtWidgets.QLabel(parent=self.layoutWidget)
        self.labelDataType.setObjectName("labelDataType")
        self.horizontalLayout_2.addWidget(self.labelDataType)
        self.comboBoxDataType = QtWidgets.QComboBox(parent=self.layoutWidget)
        ...
        self.labelMethod = QtWidgets.QLabel(parent=self.layoutWidget)
        self.labelMethod.setObjectName("labelMethod")
        self.horizontalLayout_2.addWidget(self.labelMethod)
        self.comboBoxMethod = QtWidgets.QComboBox(parent=self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.labelRootDirectory = QtWidgets.QLabel(parent=self.layoutWidget)
        self.labelRootDirectory.setObjectName("labelRootDirectory")
        self.horizontalLayout_5.addWidget(self.labelRootDirectory)
        self.lineEditRootDirectory = QtWidgets.QLineEdit(parent=self.layoutWidget)
        ...
        self.toolButtonOpenDirectory = QtWidgets.QToolButton(parent=self.layoutWidget)
        ...
        self.labelAddStandard = QtWidgets.QLabel(parent=self.layoutWidget)
        self.labelAddStandard.setObjectName("labelAddStandard")
        self.horizontalLayout_5.addWidget(self.labelAddStandard)
        self.toolButtonAddStandard = QtWidgets.QToolButton(parent=self.layoutWidget)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/resources/icons/icon-accept-64.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.checkBoxPreview = QtWidgets.QCheckBox(parent=self.layoutWidget)
        ...
        self.tableWidgetMetadata = cw.CustomTableWidget(parent=self.layoutWidget)
        ...
        self.checkBoxApplyAll = QtWidgets.QCheckBox(parent=self.layoutWidget)
        ...
        self.checkBoxSaveToRoot = QtWidgets.QCheckBox(parent=self.layoutWidget)
        ...
        self.framePreviewSample = QtWidgets.QFrame(parent=self.layoutWidget)
        ...
        self.framePreviewSample.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.framePreviewSample.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.toolButtonPrevSample = QtWidgets.QToolButton(parent=self.layoutWidget)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/resources/icons/icon-back-arrow-64.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/resources/icons/icon-forward-arrow-64.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.labelResolution = QtWidgets.QLabel(parent=self.layoutWidget)
        self.labelResolution.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.pushButtonLoad = QtWidgets.QPushButton(parent=self.layoutWidget)
